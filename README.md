...
| `swift test` | 1,177 tests, all passing |
...
| [25 — Tasks module record](docs/25-tasks-module-record.md) | The three dates, Today as a plan, the Reminders write guarantee, and what was left |
