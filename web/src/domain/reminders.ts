...
export interface Reminder {
  ...
  personIDs: string[]
  /// The project or folder it is filed in, when it is filed in one. Optional
  /// and nullable: "book a hotel" is owed to nobody and belongs to a trip;
  /// "ask Dana for the museum code" belongs to both.
