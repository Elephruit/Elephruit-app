...
final class AppEnvironment {
    ...
    /// `-EverythingDevelopmentMode YES` in the scheme's arguments.
    private let isDevelopmentMode: Bool

    init() {
        isDevelopmentMode = ProcessInfo.processInfo.arguments.contains("-EverythingDevelopmentMode")
            || UserDefaults.standard.bool(forKey: "EverythingDevelopmentMode")
    }
    ...
    func start() {
        ...
        let useTemporaryStore = ProcessInfo.processInfo.arguments.contains("-EverythingUseTemporaryStore")
