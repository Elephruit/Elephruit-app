...
public struct Importer {
    ...
    public func apply(
        ...
        var tagsByArchiveID: [UUID: EverythingModel.Tag] = [:]
    ...
    /// Everything round-trips. A file without front-matter — the usual case for Markdown from
    ...
    private func resolveItem(
        ...
        tagsByArchiveID: [UUID: EverythingModel.Tag]
    ...
    private func apply(_ record: ArchiveItem, to item: Item, tagsByArchiveID: [UUID: EverythingModel.Tag]) {
    ...
    private func resolveTag(_ record: ArchiveTag) throws(AppError) -> (EverythingModel.Tag, Bool) {
