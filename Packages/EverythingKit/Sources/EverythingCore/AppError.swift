...
extension AppError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .storeUnavailable:
            "Everything could not open your library."
        ...
        case .fileAccessDenied(let path):
            "Everything does not have permission to open “\(Self.displayName(forPath: path))”."
        ...
        case .writeFailed(let path, _):
            "Everything could not save to “\(Self.displayName(forPath: path))”."
        }
    }
    ...
    public var failureReason: String? {
        ...
        case .externalFileMissing:
            "Everything stores a reference to this file rather than a copy of it."
